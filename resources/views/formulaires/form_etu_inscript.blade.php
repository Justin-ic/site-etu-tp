    ...
    <div class="card-body">
        ...
        <form action="{{route('inscrits.store')}}" method="POST">
            ...
            <div class="form-group">
                <input class="form-control unTest" required type="hidden" name="" disabled value="OUATTARA Gninlnafanlan Justin" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" required type="text" name="annee" disabled value="2022-2023" readonly>
            </div>            
